...
const copy = {
  en: { overview: "Overview", problem: "The Problem", solution: "The Solution", architecture: "Architecture", integrations: "Integrations", challenges: "Challenges", learned: "What I Learned", technology: "Technology", live: "Live Project", github: "GitHub", next: "Next project", nextTitle: "Cabo Bay" },
  es: { overview: "Overview", problem: "El Problema", solution: "La Solución", architecture: "Arquitectura", integrations: "Integraciones", challenges: "Retos", learned: "Qué Aprendí", technology: "Tecnología", live: "Ver Proyecto", github: "GitHub", next: "Siguiente proyecto", nextTitle: "Cabo Bay" },
};

export default function Cabo101Page() {
  const { language } = useLanguage();
  const content = caseStudies[language].cabo101;
